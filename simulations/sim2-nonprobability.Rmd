...
for (r in 1:n_reps) {
  ...
  sample_nonprob <- pop_data[which(sampling::UPpoisson(pop_data$pA_1)==1),]
  sample_nonprob$w_naive <- N/n_1
  sample_prob <- pop_data[syspps(pop_data$pB_1, n_1), ] ## bottleneck
